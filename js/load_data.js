...
(function() {
  define(['utils'], function(_arg) {
    ...
    parseKrad = function(content) {
      var i, kanji, line, lines, o, radical, radicals, _base, _i, _len, _ref, _results;
      ...
      for (i = _i = 0, _len = lines.length; _i < _len; i = ++_i) {
        ...
        o = (_ref = (_base = my.kanjis)[kanji]) != null ? _ref : _base[kanji] = {
          kanji: kanji
        };
        o.radicals = radicals;
        _results.push((function() {
          var _base1, _j, _len1, _ref1, _ref2, _results1;

          _results1 = [];
          for (_j = 0, _len1 = radicals.length; _j < _len1; _j++) {
            radical = radicals[_j];
            o = (_ref1 = (_base1 = my.radicals)[radical]) != null ? _ref1 : _base1[radical] = {
              radical: radical
            };
            if ((_ref2 = o.kanjis) == null) {
              o.kanjis = "";
            }
    ...
    parseJouyou = function(content) {
      ...
      for (_j = 0, _len1 = allkanji.length; _j < _len1; _j++) {
        ...
        my.jouyou.push(char);
        _results.push((function() {
          var _base, _k, _len2, _ref, _ref1, _results1;

          _ref = my.kanjis[char].radicals;
          _results1 = [];
          for (_k = 0, _len2 = _ref.length; _k < _len2; _k++) {
            radical = _ref[_k];
            if ((_ref1 = (_base = my.jouyou_radicals)[radical]) == null) {
              _base[radical] = "";
            }
    ...
    parseKext = function(content) {
      ...
      for (i = _i = 0, _len = lines.length; _i < _len; i = ++_i) {
        ...
        entries = line.split(";");
        _results.push((function() {
          var _j, _len1, _name, _ref, _ref1, _results1;
          ...
          for (_j = 0, _len1 = entries.length; _j < _len1; _j++) {
            ...
            _results1.push(kanji != null ? (_ref1 = kanji[_name = map[name]]) != null ? _ref1 : kanji[_name] = parseMaybeNumber(obj) : void 0);
          }
          return _results1;
        })());
      }
...
/*
//@ sourceMappingURL=load_data.map
*/
