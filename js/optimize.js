...
(function() {
  ...
  require({
    ...
    handler = {
      ...
      snapNodes: function() {
        var b, coord, d, graph, i, list, node, nodes, old_length, toMove, x, y, _i, _len, _name, _ref, _ref1, _ref2, _ref3;
        graph = this.my_graph;
        grid = this.grid;
      ...
      applyRules: function() {
        ...
        return (optimizeNode = (function(_this) {
          return function() {
