...
(function() {
  ...
  define(['utils', 'criteria', 'tubeEdges'], function(utils, criteria, tube) {
    ...
    Node = (function() {
      ...
      Node.prototype.nextNodes = function() {
        ...
        return (_ref = this._nextNodes) != null ? _ref : this._nextNodes = utils.arrayUnique((function() {
      ...
      Node.prototype.ruleViolations = function(graph) {
        ...
        return (_ref = this._ruleViolations) != null ? _ref : this._ruleViolations = (function() {
      ...
      Node.prototype.critQuality = function(graph) {
        ...
        return (_ref = this._critQuality) != null ? _ref : this._critQuality = (function() {
          if (!(graph instanceof Graph)) {
            throw "graph not a Graph";
          }
    ...
    Edge = (function() {
      function Edge(_arg) {
        ...
        if ((_ref3 = this.tube) == null) {
          this.tube = null;
        }
        if ((_ref4 = this.line) == null) {
          this.line = null;
        }
        if ((_ref5 = this.style) == null) {
          this.style = {};
        }
      }
      ...
      Edge.prototype.getEdgeAngle = function() {
        ...
        return (_ref = this._getEdgeAngle) != null ? _ref : this._getEdgeAngle = (function() {
          var angle, x, x1, x2, y, y1, y2, _ref1, _ref2;

          _ref1 = [_this.source.x, _this.source.y], x1 = _ref1[0], y1 = _ref1[1];
          _ref2 = [_this.target.x, _this.target.y], x2 = _ref2[0], y2 = _ref2[1];
          x = x2 - x1;
          y = y2 - y1;
      ...
      Edge.prototype.lengthSqr = function() {
        ...
        return (_ref = this._lengthSqr) != null ? _ref : this._lengthSqr = (function() {
          var x, y, _ref1;

          _ref1 = _this.getVector(), x = _ref1[0], y = _ref1[1];
      ...
      Edge.prototype.length = function() {
        ...
        return (_ref = this._length) != null ? _ref : this._length = Math.sqrt(this.lengthSqr());
      };
      ...
      Edge.prototype.distanceToNode = function(node) {
        ...
        if ((_ref = this._distanceToNode) == null) {
          this._distanceToNode = {};
        }
        return (_ref1 = (_base = this._distanceToNode)[_name = node.id]) != null ? _ref1 : _base[_name] = (function() {
