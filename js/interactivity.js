...
(function() {
  ...
  define('interactivity', ['utils', 'tubeEdges', 'filtersearch', 'history', 'central_station', 'graph', 'detail_table', 'station_label', 'optimizer_client'], function(utils, _arg, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7) {
    ...
    View = (function() {
      function View(_arg8) {
        ...
        svg.call(this.zoom);
        this.zoom.translate([w() / 2, h() / 2]).scale(this.config.initialScale).on('zoom', styleZoom(svg.g, this.zoom));
      ...
      View.prototype.changeToCentral = function(kanji) {
        ...
        if (config.optimizer) {
          this.optimizer = new Optimizer((function(_this) {
            return function() {
      ...
      View.prototype.enterNodes = function(enter) {
        ...
        }).on('dblclick.changeToCentralFromNode', (function(_this) {
      ...
      View.prototype.addKanjiDetail = function(node) {
        ...
        return d3.selectAll('#details td.content').on('click.hightlightSelected', (function(_this) {
          return function(node) {
